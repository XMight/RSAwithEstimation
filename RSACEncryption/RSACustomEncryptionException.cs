...
{
    public class RSACustomEncryptionException : SystemException
    {
        public RSACustomEncryptionException(String message, Exception innerException)
            : base(message, innerException)
        {
        }
        
        public RSACustomEncryptionException(String message)
            : base(message)
        {
        }
    }
